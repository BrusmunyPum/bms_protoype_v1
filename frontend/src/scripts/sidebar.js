...
function initSidebarNav() {
    ...
    const isCustomers = window.location.pathname.includes('/customer/') || window.location.pathname.endsWith('customer.html') || window.location.pathname.endsWith('customers.html');
    
    let initialNav = urlParam || (isDashboard ? 'dashboard' : (isInvoices ? 'sell-invoices' : (isQuotes ? 'sell-prices' : (isCustomers ? 'sell-customers' : (savedNav || 'sell-invoices')))));
